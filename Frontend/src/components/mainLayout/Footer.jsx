...
import { faFacebook, faXTwitter, faInstagram, faRedditAlien, faGithub } from '@fortawesome/free-brands-svg-icons';
      ...
      <div className="footer-container">
        ...
        <div className="footer-social">
          <ul>
            ...
            <li><a href="https://github.com/MDG-22/BookTrackerApi" aria-label="Enlace a Github"><FontAwesomeIcon icon={faGithub} /></a></li>
          </ul>
        </div>
